...
export class UserGetController {
  ...
  getChangePassword = (req, res) => {
    ...
    if (!email) {
      return res
        .status(404)
        .render("signin", { message: "Please sign in to change the password" });
    }
...
export class UserPostController {
  ...
  createUser = async (req, res) => {
    ...
    try {
      ...
      res
        .status(201)
        .render("signin", { message: "User created successfully" });
    } catch (error) {
  ...
  changePassword = async (req, res) => {
    ...
    try {
      ...
      res
        .status(201)
        .render("signin", { message: "Password changed successfully" });
    } catch (error) {
